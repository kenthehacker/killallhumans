...
- Non-goals: no FlightSim connection or passive probe; no network socket; no
  reset, arm/disarm, flight target, powered stage, Gate 1 maneuver, plant
  identification, or safety-supervisor replacement; no claim of measured
  simulator timing.
...
- `test-vq2`: `381 passed` in 5.61 seconds. The branch did not edit the
  serialized T1 policy; the integration owner will set its expected count to
  381 and regenerate the trusted-file manifest after merging Wave 1 branches.
